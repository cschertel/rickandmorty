      ...
      `
        <div class="card">
            ...
            <div class="card-content">
                <p><span class="categoria">Nombre:</span> ${personaje.name}</p>
                <p><span class="categoria">Género:</span> ${personaje.gender=== "Female" ? "Mujer" : "" || personaje.gender=== "Male" ? "Hombre" : "" || personaje.gender=== "Genderless" ? "Sin género" : "" || personaje.gender=== "unknown" ? "No se sabe" : ""}</p>
                <p><span class="categoria">Especies:</span> ${personaje.species}</p>
                <p><span class="categoria">Estado:</span> ${personaje.status=== "Alive" ? "Vivo" : "" || personaje.status=== "Dead" ? "Muerto" : "" || personaje.status=== "unknown" ? "No se sabe" : ""}</p>
                <p><span class="categoria">Origen:</span> ${personaje.origin.name}</p>
                <p><span class="categoria">Locación:</span> ${personaje.location.name}</p>   
            </div>
            <div class="b-vermas">
